...
# /tmp/fx_sunday_l_2011.csv
# /tmp/fx_sunday_s_2011.csv
# I intend to run this script on each Sunday.

# Define the .png file which will hold the output:
png("/tmp/fx_sunday2011.png",width = 900, height = 700)

# Get the bearish data:
fx_sunday_s = read.csv("/tmp/fx_sunday_s_2011.csv")
# Get the bullish data:
fx_sunday_l = read.csv("/tmp/fx_sunday_l_2011.csv")
