...
-- Demo:
-- sqt @us_stk_past_yr.sql 2012

-- I use this script to join gains with scores for a specific year passed on the command line.

-- This script sometimes depends on ibs5min_cpy.bash
-- which fills ibs5min_cpy with recent data from ibs5min from both z2, z3.

-- Using 2012 as an example, the output I'm interested in lands here:
...
-- ibs5min_cpy might have dups so I filter them out.
...
-- The de-duped data is handy so I copy it into ibs5min_cpy:
